...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'description' => 'Opis',
        'full_description' => 'Opis penłny',
        'venue_type' => 'Typ przestrzeni',
        'event_types' => 'Typy wydarzeń',
        'area' => 'Pole powierzchni',
        'room_number' => 'Liczba pokoi',
        'restroom_number' => 'Liczba łazienek',
        'max_guests_standing' => 'Liczba gości na stojąco',
        'max_guests_seating' => 'Liczba gości na siedząco',
        'additional_rules' => 'Dodatkowe zasady',
        'price_hour' => 'Cena za godzinę',
        'min_hours' => 'Min. liczba godzin',
        'price_day' => 'Cena za dobę',
        'price_info' => 'Informacja dodatkowa',
        'security_deposit' => 'Zaliczka',
        'days_full_refund' => 'Zwrot zaliczki',
        'cancellation_information' => 'Informacja dodatkowa'
    ],
