            ...
            <div class="row">
                <div class="ui twelve wide tablet six wide computer six wide widescreen six wide large screen column" >
                    ...
                    <h3 class="text-align-center-sq">
                        Zarabiaj ze Spokoloko
                    </h3>
                    <br>

                    <p class="text-align-center-sq">   Masz lokal do wynajęcia, lub pomagasz innym tworzyć wydarzenia? <br>
                                                       Dodaj sie na serwis Spokoloko i zwieksz swoj dochod. <br>
                                                       Zarzadzaj swoja stroną, tworz promocje i Pakiety eventowe. <br>
