...
<head>
    ...
    <!-- MESSAGE SUBJECT -->
    <title>Spokoloko | Rezerwacja </title>
...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;"
            ...
            <table border="0" cellpadding="0" cellspacing="0" align="center"
                   bgcolor="#FFFFFF"
                   width="560" style="border-collapse: collapse; margin-top: 20px; border-spacing: 0; padding: 0; width: inherit;
	max-width: 560px;" class="container">
                ...
                <tr>
                    <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
			padding-top: 0px; border-radius: 8px;" class="hero"><a target="_blank" style="text-decoration: none;"
                                                                   href="https://spokoloko.eu/pl/"><img border="0"
                                                                                                        vspace="0"
                                                                                                        hspace="0"
                                                                                                        src="https://spokoloko.eu/img/logos/header-email.png"
			...
			font-family: sans-serif;" class="paragraph">
                        Witaj&nbsp;Vladislav,<br><br>W systemie została utworzona nowa rezerwacja o numerze:
                        <b>123QWERT</b><br><br>Dziękujemy za skorzystanie z usług naszego serwisu. Wkrótce skontaktujemy
                        się z Tobą w celu przekazania szczegółów rezerwacji.<br><br>Pozdrawiamy<br>Zespół Spokoloko
                    </td>
                </tr>
			...
			color: #000000;
			font-family: sans-serif;" class="paragraph">
                        Masz&nbsp;pytania? <a href="mailto:contact@spokoloko.eu" target="_blank"
                                              style="color: #127DB3; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 160%;">contact@spokoloko.eu</a>
                    </td>
                </tr>
	...
	max-width: 560px;" class="wrapper">
			...
			padding-top: 25px;" class="social-icons">
                        <table
                            ...
                            <tr>
                                ...
                                <td align="center" valign="middle"
                                    ...
                                    <a target="_blank"
                                       href="https://www.facebook.com/spokolokopl/"
                                       style="text-decoration: none;"><img border="0" vspace="0" hspace="0" style="padding: 0; margin: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: inline-block;
					color: #000000;"
                                                                           alt="F" title="Facebook"
                                                                           width="44" height="44"
                                                                           src="https://spokoloko.eu/img/logos/social-icons/facebook.png"></a>
                                </td>
                                ...
                                <td align="center" valign="middle"
                                    style="margin: 0; padding: 0; padding-left: 10px; padding-right: 10px; border-collapse: collapse; border-spacing: 0;">
                                    <a target="_blank"
                                       href="https://twitter.com/spokoloko_eu"
                                       style="text-decoration: none;"><img border="0" vspace="0" hspace="0" style="padding: 0; margin: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: inline-block;
					color: #000000;"
                                                                           alt="T" title="Twitter"
                                                                           width="44" height="44"
                                                                           src="https://spokoloko.eu/img/logos/social-icons/twitter.png"></a>
                                </td>
					...
					color: #000000;"
                                                                           ...
                                                                           width="44" height="44"
                                                                           src="https://spokoloko.eu/img/logos/social-icons/linkedin.png"></a>
                                </td>
                                ...
                                <td align="center" valign="middle"
                                    style="margin: 0; padding: 0; padding-left: 10px; padding-right: 10px; border-collapse: collapse; border-spacing: 0;">
                                    <a target="_blank"
                                       href="https://www.instagram.com/spokoloko.eu/"
                                       style="text-decoration: none;"><img border="0" vspace="0" hspace="0" style="padding: 0; margin: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: inline-block;
					color: #000000;"
                                                                           alt="I" title="Instagram"
                                                                           width="44" height="44"
                                                                           src="https://spokoloko.eu/img/logos/social-icons/instagram.png"></a>
                                </td>
			...
			font-family: sans-serif;" class="footer">
                        ...
                        ©2017 Spokoloko. All rights reserved. <a href="https://spokoloko.eu/docs/Regulamin.pdf"
                                                                 target="_blank"
                                                                 style="text-decoration: underline; color: #999999; font-family: sans-serif; font-size: 13px; font-weight: 400; line-height: 150%;">Terms
                            & Conditions</a>
