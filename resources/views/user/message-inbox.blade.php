        ...
        <div class="row">
            ...
            <div class="ui twelve wide tablet twelve wide computer eight wide widescreen eight wide large screen column">
                <div class="message-nav">
                    <a href="{{ route('messages-inbox') }}" class="message-back">
                ...
                <div class="ui tablet reversed computer reversed widescreeen reversed large screen reversed grid">
                    ...
                    <div class="ui twelve wide tablet twelve wide computer four wide widescreen four wide large screen column">
                        <div class="message-dashboard-details">
                            ...
                            @switch($venueBooking->status)
                                @case('Pending')
                                <p class="dashboard-content-sq dashboard-status-sq processing-sq"><strong>W
                                        oczekiwaniu</strong></p>
                                @break
                                @case('Confirmed')
                                <p class="dashboard-content-sq dashboard-status-sq completed-sq">
                                    <strong>Zatwierdzona</strong></p>
                                @break
                                @case('Declined')
                                <p class="dashboard-content-sq dashboard-status-sq declined-sq">
                                    <strong>Odrzucona</strong></p>
                                @break
                            @endswitch

                            @if($venueBooking->status == 'Pending')
                                <form action="{{ route('message-inbox-change-status', ['booking_number' => $venueBooking->booking_number]) }}"
                                      method="post">
                                    @csrf
                                    <input type="hidden" name="status" value="Confirmed">
                                    <button type="submit" class="button-sq small-sq see-through-sq"
                                            style="width: 100%; margin-bottom: 1em;">Zatwierdź rezerwację
                                    </button>
                                </form>
                                ...
                                <form action="{{ route('message-inbox-change-status', ['booking_number' => $venueBooking->booking_number]) }}"
                                    ...
                                    <button type="submit" class="button-sq small-sq see-through-sq"
                                            style="width: 100%; margin-bottom: 1em;">Odrzuć rezerwację
                                    </button>
                                </form>
                            @endif
                    ...
                    <div class="ui twelve wide tablet twelve wide computer eight wide widescreen eight wide large screen column">
                        ...
                        @foreach($messages as $message)
                            ...
                            <form action="{{ route('message-inbox-post', ['booking_number' => $venueBooking->booking_number]) }}"
                                  method="post">
                                @csrf
                                <div class="message-chat-item-sq dashboard-message comment-sq">
                                    ...
                                    <button type="submit" class="button-sq{{-- font-weight-extrabold-sq--}} small-sq"
                                            href="">Wyślij
                                    </button>
